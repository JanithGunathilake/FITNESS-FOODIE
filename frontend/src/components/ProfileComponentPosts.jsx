...
<div class="profile-page tx-13">
                ...
                <div class="header-links">
                    <ul class="links d-flex align-items-center mt-3 mt-md-0">
                        ...
                        <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
                            ...
                            <a class="pt-1px d-none d-md-block"style={{ marginRight: '30px' }} href="#">Workout Status </a>
                        </li>
                        <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
    ...
    <Link to="/addpost" className="btn btn-primary btn-icon-text btn-edit-profile custom-btn-width">User Post Share</Link><br/>
        ...
        <button class="btn btn-primary btn-icon-text btn-edit-profile custom-btn-width">Workout Status Share</button><br/>
...
export default ProfileComponentPosts